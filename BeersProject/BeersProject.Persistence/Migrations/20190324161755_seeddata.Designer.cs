...
namespace BeersProject.Persistence.Migrations
{
    ...
    [Migration("20190324161755_seeddata")]
            ...
            modelBuilder.Entity("BeersProject.Domain.Entities.Beer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Abv = 10m, BreweryId = 1L, Ibu = "test", Name = "biere test 1", Ounces = 10m, Style = "blanche" },
                        new { Id = 2L, Abv = 10m, BreweryId = 1L, Ibu = "test", Name = "biere test 2", Ounces = 10m, Style = "blonde" }
                    );
                });
            ...
            modelBuilder.Entity("BeersProject.Domain.Entities.Brewery", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, City = "Grenoble", Name = "Brasserie Grenobloise", State = "open" }
                    );
                });
